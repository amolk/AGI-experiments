...
setuptools.setup(
    ...
    package_data={"patternmachine": ["py.typed"]},
    ...
    entry_points={"console_scripts": ["patternmachine=patternmachine.cli:main"]},
)
