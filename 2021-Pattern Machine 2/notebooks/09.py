...
from patternmachine.signal_source.video_source import RotatingRectangleSignalSource, VideoSource
...
class DynamicsExperiment1:
    def __init__(
        self,
        image_shape: Tuple = (21, 21),
        patch_grid_shape=(3, 3),
        per_patch_pattern_grid_shape: Tuple = (7, 7),
    ):
        ...
        self.signal_source = RotatingRectangleSignalSource(
            ...
            for t in range(1, t_end):
                ...
                if hallucinate_after is not None:
                    if t > hallucinate_after:
                        raw_input_image.components["mu"].pixels.data *= 0
...
if TRAIN:
    ...
    # experiment.run(epochs=20, debug=False)
